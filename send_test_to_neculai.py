#!/usr/bin/env python
"""
Trimite email de test catre contact@neculaifantanaru.com
"""
...
def main():
    print("=" * 70)
    print("   TRIMITERE EMAIL DE TEST CATRE contact@neculaifantanaru.com")
    print("=" * 70)
    print()
...
Acesta este un email de test trimis de pe serverul bariasi.academia.iasi.ro

Detalii:
- Data si ora: {timestamp}
- Server: bariasi.academia.iasi.ro (185.182.121.45)
...
"""
        ...
        cmd = f'echo "{escaped}" | /bin/mail -s "[Test Server] Email de pe bariasi.academia.iasi.ro - {timestamp}" {TEST_TO} 2>&1'
        
        print(f"[INFO] Trimitere email catre: {TEST_TO}")
        print(f"[INFO] From: root@bariasi.academia.iasi.ro")
        print(f"[INFO] Subject: [Test Server] Email de pe bariasi.academia.iasi.ro")
        print()
