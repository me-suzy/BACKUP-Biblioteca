#!/usr/bin/env python
"""
Trimite emailul final de test de pe serverul Linux către contact@neculaifantanaru.com
"""
...
Acest email confirma ca SENDMAIL pe serverul bariasi.academia.iasi.ro functioneaza PERFECT!
...
"""
        ...
        cmd = f'echo "{escaped}" | /bin/mail -s "[SUCCESS] Sendmail functional pe bariasi.academia.iasi.ro - {timestamp}" {TEST_TO} 2>&1'
        
        print(f"[INFO] Trimitere email catre: {TEST_TO}")
        print(f"[INFO] From: root@bariasi.academia.iasi.ro")
        print(f"[INFO] Subject: [SUCCESS] Sendmail functional pe bariasi.academia.iasi.ro")
        print()
