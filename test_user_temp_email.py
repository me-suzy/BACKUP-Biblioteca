...
bariasi.academia.iasi.ro functioneaza PERFECT!
...
"""
        ...
        cmd = f'echo "{escaped}" | /bin/mail -s "[SUCCESS] Sendmail functional pe bariasi.academia.iasi.ro - {timestamp}" {TEST_EMAIL} 2>&1'
...
"""
        ...
        print("     * [SUCCESS] Sendmail functional pe bariasi.academia.iasi.ro")
        print("     * [Test simplu]")
        print()
