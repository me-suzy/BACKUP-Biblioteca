...
TEST_EMAIL = "ioan.fantanaru@gmail.com"
...
def main():
    ...
    print(f"[INFO] IP: 185.182.121.45 - EXCLUS de la PBL!")
    print()
...
Felicitari! Ai reusit sa ceri excluderea IP-ului 185.182.121.45 
de la Spamhaus Policy Blocklist (PBL)!

Detalii test:
- Server: 185.182.121.45 (bariasi.academia.iasi.ro)
- From: root@bariasi.academia.iasi.ro
- To: {TEST_EMAIL}
- Timestamp: {timestamp}
...
"""
        ...
        print(f"[INFO] From: root@bariasi.academia.iasi.ro")
        ...
        # 3. Test si cu contact@neculaifantanaru.com
        print("=" * 70)
        print("3. TEST SI CU contact@neculaifantanaru.com")
        print("=" * 70)
        print()
        
        contact_msg = f"""Test cu contact@neculaifantanaru.com dupa excluderea de la Spamhaus PBL - {timestamp}
...
- From: root@bariasi.academia.iasi.ro
- To: contact@neculaifantanaru.com
- Timestamp: {timestamp}
- Status: IP EXCLUS de la Spamhaus PBL
...
"""
        ...
        cmd2 = f'echo "{escaped2}" | /bin/mail -s "[SUCCESS] IP exclus de la Spamhaus PBL - {timestamp}" contact@neculaifantanaru.com 2>&1'
        
        print(f"[INFO] Trimitere email si la contact@neculaifantanaru.com...")
        print()
        ...
        if out2:
            ...
            print("[OK] Email trimis la contact@neculaifantanaru.com!")
        ...
        print("   2. contact@neculaifantanaru.com")
        print()
        print(">> VERIFICA INBOX-URILE:")
        print(f"   - {TEST_EMAIL} - Subject: [SUCCESS] IP exclus de la Spamhaus PBL")
        print("   - contact@neculaifantanaru.com - Subject: [SUCCESS] IP exclus de la Spamhaus PBL")
        print()
        ...
        print("   - IP-ul 185.182.121.45 a fost exclus cu succes")
        ...
        print("=" * 70)
        print()
        print("Am trimis emailuri de test la Gmail si contact@neculaifantanaru.com.")
