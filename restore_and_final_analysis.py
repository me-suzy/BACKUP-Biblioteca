...
"""
        ...
        print("   - IP-ul 185.182.121.45 este pe blacklist-uri")
        ...
        print("   - Cere configurarea PTR pentru 185.182.121.45")
        print("   - Exemplu: 185.182.121.45 -> mail.bariasi.academia.iasi.ro")
        print()
        print(">> PENTRU DELISTING DE LA SPAMHAUS:")
        print("   - Intră pe: https://www.spamhaus.org/zen/")
        print("   - Cere delisting pentru 185.182.121.45")
