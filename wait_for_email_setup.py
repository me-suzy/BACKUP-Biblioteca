#!/usr/bin/env python
"""
Script care asteapta ca utilizatorul sa configureze adresa contact@neculaifantanaru.com
...
def main():
    print("=" * 70)
    print("   CONFIGURARE SI TEST contact@neculaifantanaru.com")
    print("=" * 70)
    print()
    ...
    print("   - Add Forwarder:")
    print("     * Address: contact@neculaifantanaru.com")
    print("     * Destination: [adresa ta]")
    print()
    print("3. Dupa ce ai configurat, apasa ENTER aici pentru a testa.")
    print()
    
    input("Apasa ENTER cand ai configurat adresa contact@neculaifantanaru.com...")
    print()
...
Acest email a fost trimis cu succes de pe serverul bariasi.academia.iasi.ro

Detalii tehnice:
- Data si ora: {timestamp}
- Server sursa: bariasi.academia.iasi.ro (185.182.121.45)
- De la: root@bariasi.academia.iasi.ro
- Catre: {TEST_TO}
...
"""
        ...
        cmd = f'echo "{escaped}" | /bin/mail -s "[SUCCESS] Email de pe bariasi.academia.iasi.ro - {timestamp}" {TEST_TO} 2>&1'
        
        print(f"[INFO] Trimitere email catre: {TEST_TO}")
        print(f"[INFO] Subject: [SUCCESS] Email de pe bariasi.academia.iasi.ro")
        print()
