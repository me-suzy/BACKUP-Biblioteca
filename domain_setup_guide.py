...
def main():
    ...
    print("   - IP-ul 185.182.121.45 nu are domeniu asociat")
    print("   - Gmail vede root@bariasi.academia.iasi.ro ca spam")
    ...
    print("   3. Adauga A record: mail.academia.iasi.ro -> 185.182.121.45")
    print("   4. Adauga PTR record: 185.182.121.45 -> mail.academia.iasi.ro")
    ...
    print("     * Name: mail")
    print("     * Type: A")
    print("     * Value: 185.182.121.45")
    print()
    print("   PASUL 3: CERE PTR RECORD")
    print("   - Contacteaza providerul de internet pentru 185.182.121.45")
    print("   - Cere configurarea PTR record:")
    print("     185.182.121.45 -> mail.academia.iasi.ro")
    print()
    ...
    print("   - In loc de: root@bariasi.academia.iasi.ro")
    print()
    
    print(">> ALTERNATIVA RAPIDA:")
    print("   - Foloseste un domeniu pe care il ai deja")
    print("   - Adauga A record: mail.tudomeniu.ro -> 185.182.121.45")
