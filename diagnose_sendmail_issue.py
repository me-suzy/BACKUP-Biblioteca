...
"""
        ...
        cmd1 = f'echo "{escaped}" | mail -s "Test direct mail" ioan.fantanaru@gmail.com 2>&1'
        ...
        cmd2 = f'echo -e "To: ioan.fantanaru@gmail.com\\nSubject: Test direct sendmail\\n\\n{escaped}" | sendmail -v ioan.fantanaru@gmail.com 2>&1'
        ...
        if out:
            ...
            for line in lines:
                if not line.strip():
                    continue
                lw = line.lower()
                if "ioan.fantanaru" in lw or "gmail" in lw:
                    if "stat=sent" in lw:
        ...
        print("   3. IP-ul 185.182.121.45 este blocat")
