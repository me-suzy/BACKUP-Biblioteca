...
def main():
    ...
    try:
        ...
        if out:
            print("Logs pentru emailurile catre contact@neculaifantanaru.com:")
            print("-" * 70)
            ...
            print("[INFO] Nu am gasit logs pentru emailurile catre contact@neculaifantanaru.com")
...
"""
        ...
        print("   4. Domeniul bariasi.academia.iasi.ro nu are SPF/DKIM")
        print()
