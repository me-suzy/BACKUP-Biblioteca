#!/usr/bin/env python
"""
Verifica cine gestioneaza DNS-ul pentru domeniul bariasi.academia.iasi.ro
"""
...
DOMAIN = "bariasi.academia.iasi.ro"
...
def main():
    ...
    try:
        ...
        print("   v=spf1 ip4:185.182.121.45 ~all")
        print()
        print(">> UNDE SA CONFIGUREZI:")
        print("   1. Cauta cine gestioneaza DNS-ul pentru bariasi.academia.iasi.ro")
        ...
        print("   - Host/Name: @ (sau bariasi.academia.iasi.ro)")
        print("   - Type: TXT")
        print("   - Value: v=spf1 ip4:185.182.121.45 ~all")
        print("   - TTL: 3600 (1 ora)")
        print()
        print(">> DUPĂ CONFIGURARE:")
        print("   - Așteaptă 24-48 ore pentru propagare")
        print("   - Testează din nou emailurile")
        print("   - Verifică cu: host -t TXT bariasi.academia.iasi.ro")
        print()
